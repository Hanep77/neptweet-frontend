    ...
    return (
        <header className="fixed top-0 right-0 left-0">
            <nav className="flex justify-around items-center m-auto h-16 bg-white border rounded-b">
                ...
                <button type="button" className="flex h-8 bg-red-500 hover:bg-red-600 active:bg-red-700 text-white items-center gap-2 border rounded-md px-2" onClick={handleLogout}><BiLogOut /> Logout</button>
            </nav>
        </header>
    )
}